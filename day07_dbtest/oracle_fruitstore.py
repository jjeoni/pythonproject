...
# 2.수정 : 현재 재고현황을 출력한 후 수정할 과일 이름을 입력한 후 if절과 input문을 이용해 입력받은 가격과 수량을 update를 이용해 수정
# 3.삭제 : 현재 재고현황을 출력한 후 삭제할 과일 이름을 입력한 후 삭제되었다는 메세지 출력 후 재고리스트 출력
# 4.재고리스트 : 현재 재고현황을 가격을 기준으로 내림차순 정렬 후 출력
# 5.종료 : 프로그램 종료 메세지 출력
